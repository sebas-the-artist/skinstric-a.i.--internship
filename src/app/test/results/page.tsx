...
export default function ResultsPage() {
  ...
  const getCircleLabel = () => {
    if (activeItem)
      return activeItem.replace(/-/g, " ").replace(/\b\w/g, (l) => l.toUpperCase());
  ...
  return (
    <div className="results-page">
      {/* Back bottom-left */}
      <div className="results-nav results-nav--back">
        <button
          type="button"
      ...
      {/* Home bottom-right */}
      <div className="results-nav results-nav--home">
        <span className="proceed-button-label">Home</span>
        <button
          type="button"
